...
public class Principal {
	...
	public static void questao3_For() {
		...
		System.out.println("Resultado da soma dos números de 1 a 100: " + soma + "\n");
	}
	...
	public static void questao5_While(Scanner scan) {
		...
		// SEU CÓDIGO AQUI
		 ...
		 System.out.println("Resultado da soma de todos os números digitados:\n " + soma);
		 System.out.println();
	}
	...
	public static void questao9_WhileScanner(Scanner scan) {
		...
		// SEU CÓDIGO AQUI
		 ...
		 System.out.println("Quantidade de números positivos digitados:\n " + cont);
